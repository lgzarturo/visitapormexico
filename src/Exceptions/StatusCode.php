...
class StatusCode
{
    ...
    /**
     * Returns the action name associated with a given HTTP status code.
     *
     * @param int $statusCode The HTTP status code to get the action name for.
     *
     * @return string The action name associated with the given HTTP status code.
     *
     */
    public static function getActionFromStatusCode(int $statusCode): string {
        $action = 'serverError';
        switch ($statusCode) {
            ...
            case StatusCode::HTTP_INTERNAL_SERVER_ERROR:
                $action = 'serverError';
                break;
            case StatusCode::HTTP_REQUEST_URI_TOO_LONG:
                $action = 'uriTooLong';
                break;
        }
        return $action;
